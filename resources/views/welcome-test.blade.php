...
<div class="flex-center position-ref full-height">
    ...
    <div class="content">
        ...
        <img  height="350" src="<?php echo asset("public/images/sakura.jpg")?>" class="img-responsive"></a>
        <div class="links">
            <br>
            <a class="button green" href="{{route('main')}}" value="Смотреть анкеты" role="link">Смотреть анеты</a>
            <a class="button blue" href="{{route('createGirlPage')}}" value="Смотреть анкеты" role="link">Разместить анкету</a>
