...
<div class="container">
    ...
    <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <div class="row">
                <form action="{{route('search')}}" method="post" enctype="multipart/form-data" novalidate>
                    {{ csrf_field() }}
                    <label>Страна:
                    ...
                    <button type="submit" class="btn btn-default">Найти анкету</button>
                </form>
                <a class="button blue" href="{{route('main2')}}" role="link">Сброс фильтра</a>
                    <br>
                    <b>Анкеты:</b><br> <br>
                ...
                @else
                    ...
                    <!-- {{$girl=Auth::user()->anketisExsis()}} -->
                        ...
                        <a href="{{route('girlsShowAuchAnket')}}">
                            <img  height="150" width="150" src="<?php echo asset("public/images/upload/$girl->main_image")?>">
                        </a><br>
                        <a href="{{route('girlsShowAuchAnket')}}">
                    ...
                    @else
                        <b> У Вас пока не создана анкета.<br>
                            Хотите создать её?</b>
                        <br>
                        <a class="button blue" href="{{ route('createGirlPage') }}">Создать анкету</a><br>

                    @endif
                    @if(Auth::user()->isAdmin==1)
                        <a class="button green" href="{{ route('adminPanel') }}">Открыть панель администратора</a><br>
                    @endif
