...
<div class="container">
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.2.0/angular.min.js"></script>
        ...
        <div class="span8 ">
            ...
            <div class="span4">
        @if (Auth::guest())
            <a class="button green" href="{{ route('login') }}">Войти1</a><br>
        ...
        @else
            ...
            @if(Auth::user()->anketisExsis()==true)
                <a class="button green" href="{{route('girlsShowAuchAnket')}}" role="link">Смотреть свою анкету</a>
            @else
                У вас пока не создана анкета.<br>
                Хотите создать её?
                <br>
                 <a class="button blue" href="{{route('girlsCreateView')}}" value="Смотреть анкеты" role="link">
                     Создать анкету</a>
            @endif
        @endif
